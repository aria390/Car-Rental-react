...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <p className="text-[24px] font-medium text-[#2563eb]">
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="border rounded-md text-[14px] placeholder:text-gray-400 border-gray-200 w-[300px] p-2 outline-[#2563eb]"
              type="email"
            />
          </div>
          <div className="flex flex-col gap-2">
          ...
          <div className="flex justify-center ">
            <button
              type="submit"
              className="bg-[#2563eb] text-white px-32 rounded-md py-2 text-[14px] cursor-pointer hover:bg-blue-700"
            >
              Login
            </button>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="flex justify-center ">
              <button
                type="submit"
                className="bg-[#2563eb] text-white px-24 rounded-md py-2 text-[14px] cursor-pointer hover:bg-blue-700"
              >
                Create Account
              </button>
            </div>
